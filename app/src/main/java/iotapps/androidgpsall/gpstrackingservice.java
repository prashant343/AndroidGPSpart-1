...
/**
 * Created by prashantkaushik on 23/03/17.
 */
...
public class gpstrackingservice extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                // Corse Location are given by the network provider
                if (isNetworkEnabled) {
                ...
                // if GPS Enabled get lat/long using GPS Services Fine Location is captured by GPS
                if (isGPSEnabled) {
                    if (location == null) {
                        locationManager.requestLocationUpdates(
    ...
    public void showSettingsAlert() {
       // we will use this in next tutorial for showing the setting screens to user.
    }
